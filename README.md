...
1. Getting a picture to pop up after one is swiped away
2. Getting the picture to fade as it is panned away

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='Tinder_Demo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

It took me a while to realize that I accidentally disabled user interaction. Won't be making that mistake again!
